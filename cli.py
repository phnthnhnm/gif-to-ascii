...
def parse_arguments():
    ...
    parser.add_argument('gif_file', type=str, nargs='?', help='Path to the input GIF file')
    ...
    if not args.gui and not args.gif_file:
        parser.error("the following arguments are required unless -gui is specified: gif_file")
    return args
